...
import { CreateServiceSchema, ListServicesSchema } from '@/lib/schemas/service.schema';
import { createService, listServices } from '@/services/service.service';
import { AppError } from '@/lib/errors';

// Both roles can list services (needed when creating invoices/line items)
export const GET = withAuth(async (req: AuthedRequest) => {
  ...
  try {
    const data = await listServices(result.data);
